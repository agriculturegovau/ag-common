...
}`,...(Z=(Q=w.parameters)==null?void 0:Q.docs)==null?void 0:Z.source}}};var _,ee,ne;O.parameters={...O.parameters,docs:{...(_=O.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    onEvent: (name, data) => {
      alert(\`trackEvent(\${name}, \${JSON.stringify(data)})\`);
    }
...
}`,...(ne=(ee=O.parameters)==null?void 0:ee.docs)==null?void 0:ne.source}}};var te,re,ae;E.parameters={...E.parameters,docs:{...(te=E.parameters)==null?void 0:te.docs,source:{originalSource:`{
  args: {
    onEvent: (name, data) => {
      alert(\`trackEvent(\${name}, \${JSON.stringify(data)})\`);
    }
...
}`,...(ae=(re=E.parameters)==null?void 0:re.docs)==null?void 0:ae.source}}};const Re=["Default","CustomEventHandler","NestedDataContext","NestedEventListeners"];export{w as CustomEventHandler,x as Default,O as NestedDataContext,E as NestedEventListeners,Re as __namedExportsOrder,Ie as default};
